        ...
        <div className="grid gap-10 row-gap-6 lg:grid-cols-2">
          <div className="">
            ...
            <div className="flex flex-row sm:items-center sm:gap-y-0 gap-x-4">
              <a className="font-normal text-white " href="#">
                Download Now
              </a>
              <a className="font-normal text-white " href="#">
                License
            ...
            <p className="mt-4  text-white">© 2021 Chopmoney. All rights reserved</p>
            <div className="flex items-center mt-1 space-x-3">
              <a
                href="/"
                className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 fill-white">
              ...
              <a
                ...
                className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400"
              >
                <svg viewBox="0 0 30 30" fill="currentColor" className="h-6 fill-white">
